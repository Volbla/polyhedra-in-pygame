...
VectorArray = NDArray[Shape["*,3"], Float] | NDArray[Shape["*,*,3"], Float]

# Either a single shape (of n faces, each with m corners), or a list of such shapes.
ShapeArray = NDArray[Shape["*,*,3"], Float] | NDArray[Shape["*,*,*,3"], Float]
...
Color = Sequence[int|float] | NDArray[Shape["3"], Float] | NDArray[Shape["4"], Float]
ColorArray = NDArray[Shape["*,3"], Float] | NDArray[Shape["*,4"], Float]
